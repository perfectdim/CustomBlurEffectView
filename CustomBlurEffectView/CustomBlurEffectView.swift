...
public class CustomBlurEffectView: UIView {
    ...
    /// Blur radius. The default value is 10
    public var blurRadius: CGFloat = 10.0 {
        didSet {
            print("___", blurRadius)
    ...
    /// Tint color alpha. The default value is 0.8
...
//        if #available(iOS 14.0, *) {
//            _setValue(blurRadius, forKey: "blurRadius")
//            _setValue(colorTint, forKey: "colorTint")
//            _setValue(colorTintAlpha, forKey: "colorTintAlpha")
//        }
    }
